...
#include <Adafruit_ST7789.h> // Hardware-specific library for ST7789
  ...
  #define ST77XX_CS         14
  #define ST77XX_RST        15
  #define ST77XX_DC         32

#elif defined(ESP8266)
  #define ST77XX_CS         4
  #define ST77XX_RST        16                                            
  #define ST77XX_DC         5
  ...
  #define ST77XX_CS         4
  #define ST77XX_RST        5 // Or set to -1 and connect to Arduino RESET pin
  #define ST77XX_DC         6
#endif
// For 1.44" and 1.8" TFT with ST7735 use:
Adafruit_ST7735 tft = Adafruit_ST7735(ST77XX_CS, ST77XX_DC, ST77XX_RST);
...
void setup() {
  ...
  REG_PMC_PCER1 = 1<<4;               // activate clock for PWM controller bll
...
static void captureImg(uint16_t wg, uint16_t hg){
  ...
  for (y = 0; y < 128; y++) {
    for (x = 0; x < 128; x++) {
      int color = myImage[y+60][x+100];
      tft.pushColor(tft.color565(color,color,color));
    }
  }
  tft.endWrite();
